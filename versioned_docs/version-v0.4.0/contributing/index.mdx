...
For additional information about testing, please refer to the [tests documentation](https://github.com/llamastack/llama-stack/blob/main/tests/README.md) for both unit and integration test.
...
2. **Present at a community call** (optional): Bring your proposal to a [community call](https://github.com/llamastack/llama-stack#community) to gather feedback, answer questions, and build consensus with other contributors and maintainers.
...
* Llama Stack utilizes [custom Exception classes](https://github.com/llamastack/llama-stack/blob/main/llama_stack/apis/common/errors.py) for certain Resources that should be used where applicable.
...
For information about how Llama Stack versions are released, including release schedules, testing requirements, and how to contribute to releases, see [RELEASE_PROCESS.md](https://github.com/llamastack/llama-stack/blob/main/RELEASE_PROCESS.md).
